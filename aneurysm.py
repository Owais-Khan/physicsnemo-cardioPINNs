...
def run(cfg: PhysicsNeMoConfig) -> None:
    ...
    print (0)
    inlet_mesh     = Tessellation.from_stl(point_path + "/mesh-surfaces/cap_Aorta.stl", airtight=False)
    outlet_Branch1 = Tessellation.from_stl(point_path + "/mesh-surfaces/cap_Branch1.stl", airtight=False)
    outlet_Branch2 = Tessellation.from_stl(point_path + "/mesh-surfaces/cap_Branch2.stl", airtight=False)
    outlet_Branch3 = Tessellation.from_stl(point_path + "/mesh-surfaces/cap_Branch3.stl", airtight=False)
    outlet_Branch4 = Tessellation.from_stl(point_path + "/mesh-surfaces/cap_Aorta_2.stl", airtight=False)
    noslip_mesh    = Tessellation.from_stl(point_path + "/mesh-surfaces/cap_Branch3.stl", airtight=False)
