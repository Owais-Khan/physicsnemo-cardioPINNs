...
def run(cfg: PhysicsNeMoConfig) -> None:
    ...
    VelocityMeanAdjusted=0.8*(VelocityMean/(-0.01*RadiusThreshold+2))
...
#---------------------------- Constraints -----------------------------#
    ...
    integral_continuity = IntegralBoundaryConstraint( 
        ...
        lambda_weighting={"normal_dot_vel": VelocityMeanAdjusted/InflowRate*0.01*(100-RadiusThreshold)},
        )                      
...
if __name__ == "__main__":
    ...
    VelocityFilePath=velocity_files[7]
    run()
